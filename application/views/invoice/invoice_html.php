	                                ...
	                                <tbody>
                                        ...
                                        $return_amount = 0;
										 foreach($invoice_all_data as $details){?>
                                           <?php
                                $categoryes =$this->db->select('*')->from('product_category')->where('category_id',$details->category_id)->get()->result(); 
                                  
                                    foreach($categoryes as $cats){
                                    ?>
										...
										<tr>
	                                        ...
	                                        <td class="text-center"><div><strong><?php echo html_escape($details['product_name']).' - '.html_escape($details['strength']).' - '.html_escape($cats['category_name']);
