             ...
             if($this->permission1->module('new_invoice')->access() || $this->permission1->module('manage_invoice')->access() || $this->permission1->module('pos_invoice')->access()|| $this->permission1->module('gui_pos')->access()) { ?>
                <li class="treeview <?php if ($this->uri->segment('1') == ("Cinvoice")) { echo "active";}else{ echo " ";}?>">
                    ...
                    <ul class="treeview-menu">
                        ...
                        echo " ";
                    }?>"><a href="<?php echo base_url('Cinvoice/gui_pos')?>"><?php echo display('Sales') ?></a></li>
                          <?php } ?>
                    </ul>
                </li>
            <?php } ?>
            ...
            if($this->permission1->module('add_purchase')->access() || $this->permission1->module('manage_purchase')->access()){ ?>
             <li class="treeview <?php if ($this->uri->segment('1') == ("Cpurchase")) { echo "active";}else{ echo " ";}?>">
                ...
                <ul class="treeview-menu">
                    ...
                    ?>
                    <?php
                        if($this->permission1->method('uploadCsv_Purchase','create')->access()) { ?>
                            <li  class="treeview <?php if ($this->uri->segment('2') == ("add_purchase_csv")){
                        echo "active";
                    } else {
                        echo " ";
                    }?>"><a href="<?php echo base_url('Cpurchase/add_purchase_csv')?>"><?php echo display('import_purchase_csv') ?></a></li>
                        <?php } ?>
                </ul>
             </li>
           <?php } ?>
         ...
         <?php }?>
           ...
           <?php }?>
            ...
            <!-- Synchronizer setting end -->
             <li><a href="https://forum.bdtask.com/" target="blank"><i class="fa fa-question-circle"></i> Support</a></li>
             <li><a href="<?php echo base_url('Documentation-Pharmacare/') ?>" target="blank"><i class="fa fa-question-circle"></i> Documentation</a></li>
                </ul>
            </li>
