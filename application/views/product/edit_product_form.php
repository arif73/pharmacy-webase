                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <input class="form-control" name="box_size" type="text" id="box_size" tabindex="3" placeholder="<?php echo display('box_size') ?>" value="{box_size}" min="0">
                                    </div>
                                </div>
                            </div>
                             <div class="col-sm-6">
                                <div class="form-group row">
                                    <label for="strength" class="col-sm-4 col-form-label"><?php echo display('strength') ?></label>
                                    <div class="col-sm-8">
                                        <input class="form-control" name="strength" type="text" id="strength" tabindex="3" placeholder="<?php echo display('strength') ?>"  value="{strength}">
                                    </div>
                                </div>
                            </div>
